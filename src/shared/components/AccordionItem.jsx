...
export function AccordionItem({ eventKey, children, className = null, parentBorder = null }) {
       ...
       return (
              <div className={parentBorder && "border border-blue-200 rounded-lg"}>
                     {/* Header */}
                     <div
                     ...
                     >
                            {children[0]}
                            <svg
                                   className={`w-4 h-4 transition-transform stroke-text_secondary duration-300 ${isOpen ? "rotate-180" : ""}`}
                                   fill="none"
                                   stroke=""
                                   strokeWidth="2"
                                   viewBox="0 0 24 24"
