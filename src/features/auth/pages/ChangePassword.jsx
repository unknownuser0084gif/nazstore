              ...
              <section className="w-full mt-18 max-md:px-4 max-md:mt-24">
                     <div className="w-lg max-md:w-full py-8 shadow-trigger rounded-2xl mx-auto font-main px-6 border border-box_secondary" dir="rtl">
                            <div className="w-full">
                                   ...
                                   <h1 className="font-main-bold text-center text-2xl text-text_secondary">تعویض رمز عبور</h1>
                                   <div className="w-full mt-8 relative">
                                          <input type="text" className="input-control-2 mt-2 peer ps-12! shadow" name="" id="" onBlur={e => setPhone(e.target.value)} />
                                          <label htmlFor="" className={`text-lg ${phone !== "" ? "-top-2 opacity-100 right-0!" : "top-[55%]"} peer-focus:-top-2 peer-focus:right-0 peer-focus:opacity-100 pointer-events-none absolute -translate-y-1/2 right-12 opacity-70 transition-all`}>رمز جدید </label>
                                   ...
                                   <div className={`${(!passFocus && !password) ? "mt-4" : "mt-12"} w-full relative transition-all`}>
                                          ...
                                          <label htmlFor="" className={`text-lg ${password !== "" ? "-top-3 opacity-100 right-0!" : "top-[55%]"} peer-focus:-top-3 peer-focus:right-0 peer-focus:opacity-100 pointer-events-none absolute  -translate-y-1/2 right-12 opacity-70 transition-all`}>تکرار رمز جدید</label>
                                          <MdOutlinePassword className="absolute top-[55%] size-6 -translate-y-1/2 right-4 text-text_secondary" />
                                   </div>
                                   <button className="mt-6 cursor-pointer rounded-lg py-3 w-full bg-box_primary text-white">ثبت</button>
                            </div>
                     </div>
              </section>
       )
